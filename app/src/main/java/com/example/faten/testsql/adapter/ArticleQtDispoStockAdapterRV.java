 ...
 */
public class ArticleQtDispoStockAdapterRV extends RecyclerView.Adapter<ArticleQtDispoStockAdapterRV.ViewHolder> {
    ...
    public ArticleQtDispoStockAdapterRV(Activity activity, ArrayList<ArticleStock> listArticle) {
        ...
        holder.card_depot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nbr_click < articleStock.getQuantite()) {
                  ...
                  /*   if (!SelectStockLivraisonActivity.listArticlePanierLivraison.contains(article)) {

                        SelectStockLivraisonActivity.listArticlePanierLivraison.add(article);
                    }
                    else
                    {
                        int index_article_panier = SelectStockLivraisonActivity.listArticlePanierLivraison.indexOf(article);
                        SelectStockLivraisonActivity.listArticlePanierLivraison.set(index_article_panier, article);
                    }  */
            ...
            public boolean onLongClick(View view) {
                ...
                if (articleStock.getQuantite() != 0) {
                    ...
                    try {
                        ...
                        DialogChoixEditORDeleteChoix dialog = new DialogChoixEditORDeleteChoix();

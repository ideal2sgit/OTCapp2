 ...
 */
public class DemandeArticleViewAdapterRV extends RecyclerView.Adapter<DemandeArticleViewAdapterRV.ViewHolder> {
    ...
    public DemandeArticleViewAdapterRV(Activity activity, ArrayList<ReservationArticleDansDepot> listDemande) {

 ...
 */
public class ArticlePanierAdapter extends RecyclerView.Adapter<ArticlePanierAdapter.ViewHolder> {
    ...
    public ArticlePanierAdapter(Activity activity, ArrayList<ArticleStock> listArticle) {
        ...
        AlertDialog.Builder dialog = new AlertDialog.Builder(activity)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Iterator<ReservationArticleDansDepot> iter = BonCommandeVenteAvecTerminalActivity.listReservation.iterator();
                        ...
                        Log.e("LIST_RESERV "+BonCommandeVenteAvecTerminalActivity.listReservation.size() ,""+BonCommandeVenteAvecTerminalActivity.listReservation.toString());




                        Log.e("RESECATION", "" + BonCommandeVenteAvecTerminalActivity.listReservation.size());

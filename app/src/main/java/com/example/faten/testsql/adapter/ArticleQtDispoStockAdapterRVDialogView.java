 ...
 */
public class ArticleQtDispoStockAdapterRVDialogView
        extends RecyclerView.Adapter<ArticleQtDispoStockAdapterRVDialogView.ViewHolder> {
    ...
    public ArticleQtDispoStockAdapterRVDialogView(Activity activity, ArrayList<ArticleStock> listArticle) {

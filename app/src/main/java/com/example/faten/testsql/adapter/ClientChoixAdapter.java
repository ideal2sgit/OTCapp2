 ...
 */
public class ClientChoixAdapter extends ArrayAdapter<Client> {
    ...
    public ClientChoixAdapter(Activity activity  , ArrayList<Client> listClient) {
        super(activity, R.layout.item_client_choix , listClient);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.item_client_choix , null, true);
